  ...
  plus: {
    datepicker: {
      ...
      shortcutsDaterange: {
        ...
        pastThreeMonths: "Past three months"
      },
      shortcutsMonthrange: {
    ...
    input: {
      ...
      validateInteger: "Please enter a valid integer",
    ...
    selectIcon: {
      ...
      dialogTitle: "Please select icon",
      searchPlaceholder: "Search icon",
      emptyDescription: "No icon found"
    },
    copy: {
      copySuccess: "Copy success",
      copyFail: "Copy fail",
      invalidCopyContent: "Invalid copy content"
    },
    selectTable: {
      searchBtnTxt: "Search",
      radioTxt: "Radio",
    ...
    stepWizard: {
      lastBtnTitle: "Complete"
    },
    table: {
      columnBind: {
        btnTxt: "Column setting",
