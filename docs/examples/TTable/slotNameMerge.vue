<template>
  <t-layout-page>
    <t-layout-page-item>
      ...
      >
        <template #slotNameMergeDate1="{ scope }">{{
          scope.row.date1
        }}</template>
        <template #slotNameMergename="{ scope }">{{ scope.row.name }}</template>
        <template #slotNameMergeaddress="{ scope }">{{
          scope.row.address
        }}</template>
      </t-table>
    </t-layout-page-item>
  ...
  columns: [
    {
      ...
      children: [
              ...
              children: [
                {
                  ...
                  label: '日期插槽使用',
                  minWidth: '180',
                  slotNameMerge: 'slotNameMergeDate1',
                },
              ],
            },
          ],
        },
        {
          ...
          label: '姓名插槽使用',
          minWidth: '100',
          slotNameMerge: 'slotNameMergename',
        },
        {
          prop: 'date',
          label: '表头合并2',
