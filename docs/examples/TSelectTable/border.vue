<template>
  <t-layout-page>
    <t-layout-page-item>
      <el-radio-group v-model="border" size="small" style="margin-bottom: 15px">
        <el-radio-button :value="true">有边框</el-radio-button>
        <el-radio-button :value="false">无边框</el-radio-button>
      </el-radio-group>
    </t-layout-page-item>
    <t-layout-page-item>
      <t-select-table
